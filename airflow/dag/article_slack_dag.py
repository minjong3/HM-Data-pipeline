...
SPARK_STEPS = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": [
                ...
                "--data_source",
                "s3a://11team-hm/source/articles.csv",
                "--output_uri",
                "s3a://11team-hm/ final_output/articles/"
            ],
        },
    }
]
...
with DAG(
    ...
    schedule_interval='0 5 * * *',  # 매일 2시에 실행
    tags=["emr"],
    ...
    #step_adder 라는 이전 task의 결과를 대기하고 완료되면 다음 단계로 진행한다는 내용
